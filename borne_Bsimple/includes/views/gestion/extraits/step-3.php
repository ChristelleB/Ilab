...
<!-- CONTAINER  -->
<div class="container vw-extraits-step-3">

	<div class='page_header'>

		<a class='header_left' href="/logged.php"> Revenir à l'acceuil </a>

		<h1> Vos opérations en rapport avec le compte XXXX </h1>
	...
	<div class='page_footer'>
		...
		<a class='footer_left' href="/gestion/extraits/step-2.php"> retourner a l'étape précedente </a>
